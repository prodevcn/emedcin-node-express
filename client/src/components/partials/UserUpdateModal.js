...
class UserUpdateModal extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            verified: this.props.record.verified,
            password: '',
            errors: {},
        };
    ...
    componentDidMount() {
        ...
        console.log(this.props.record.verified);
    }
    componentWillReceiveProps(nextProps) {
        if (nextProps.record) {
            this.setState({
                ...
                verified: nextProps.record.verified,
            })
        }
        if (nextProps.errors) {
            this.setState({
    ...
    onChange = e => {
        ...
        if (e.target.id === 'user-update-role') {
            this.setState({role:e.target.value});
            // console.log(e.target.value);
        }
        if (e.target.id === 'user-update-verify') {
                            ...
                            <div className="modal-body">
                                <form noValidate onSubmit={this.onUserUpdate} id="update-user">
                                    ...
                                    <div className="row mt-2">
                                        ...
                                        <div className="col-md-9">
                                            <select id ="user-update-role" value={this.state.role} onChange={this.onChange}>
                                    ...
                                    <div className="row mt-2">
                                        ...
                                        <div className="col-md-9">
                                            <select id ="user-update-verify" value={this.state.verified} onChange={this.onChange}>
